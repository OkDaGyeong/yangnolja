...
public class ReReservation extends JFrame implements ActionListener {
      ...
      try {
         ...
         if (strRoomNo.equals("")) {
            ...
            return;
        	 ...
        	 sql = "update reservation set room_no="+ roomNo
        	 		+ ",check_in='"+ checkIn
        	 		+ "', check_out='"+ checkOut
        	 		+ "', team_num="+ teamNo
        	 		+ ", memo='"+ checkIn+ " ~ "+ checkOut+ " :  Room "+ roomNo+ "이 예약된 상태입니다.' "
        	 		+ "where reser_no="+ reNum+ ";";
   ...
   JButton btnnext = new RoundButton("변경하기");
   JButton btnBack = new RoundButton("변경취소");
